...
'use strict';
const BlankPNG =
	'data:image/webp;base64,UklGRkAAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAIAAAAAAFZQOCAYAAAAMAEAnQEqAQABAAFAJiWkAANwAP789AAA',
	WIN = window,
	DOC = document,
	EBody = DOC['body'],
	EElement = DOC['documentElement'],
	RESPATH = 'images/interface/',
	dSurface = $('dSurface'),
	PKindUpperLimit = 0x5,
	PKindTraverseOrder = [
		0x5,
	...
	WaterShadowImg = 'images/Zombies/WaterShadow.webp',
	WaterSplashImg = 'images/Zombies/Drop_Water.webp',
	EVENT_STARTGAME = new Event('jng-event-startgame'),
...
let $User = {
	...
	oSym = {
		'Init'(a, b = []) {
			...
			c['Now'] = 0x0, c['Timer'] = null, (c['TQ'] = new Set())['add']({
				...
				'f': a,
				'ar': b
			}), c['NowStep'] = 0x1, c['TimeStep'] = 0xa, c['NowSpeed'] = 0x1, $User['NowSpeed'] && CSpeed($User[
				'NowSpeed'], ![]), c['Start']();
		},
		'Start'() {
			const a = this;
	...
	LevelConfig = {
		'config': {
			...
			'Polar': {
				...
				get 'LoadAccess'() {
					return b => {
						PlayAudio('Bgm_Polar_Noise', 0x1), NewImg('imgKK', 'images/interface/Polar_Mask' + (oS[
								'DKind'] ? '2' : '4') + '.webp', 'left:' + (oS['DKind'] ? 0x46b : 0x44c) +
							'px;', EDAll), NewImg('imgKK', 'images/interface/Polar_Mask' + (oS['DKind'] ?
							'1' : '3') + '.webp', 'left:167px;top:546px;', EDAll), !oS['DKind'] && (NewEle(
							'PolarFire2', 'div', null, {
								'className': 'PolarFire'
							}, $('tGround')), NewEle('PolarFire', 'div', null, {
							'className': 'PolarFire'
						}, $('tGround'))), oSym['addTask'](0x5a, b);
					};
				},
				'DynamicDifficulty': !![],
				'AllowUserCard': !![],
			...
			'Industry': {
				...
				'AllowUserCard': !![],
				get 'StartGameMusic'() {
					return oS['Lvl']['replace'](/[^0-9]/ig, '') < 0x15 ? 'Bgm_Industry_Fight' :
						'Bgm_Industry_Fight_2';
				},
				'LoadAccess'(a) {
					NewImg('BgMask' + Math['random'](), 'images/interface/Industry_Mask.png',
						'left:0;top:469px;position:absolute;z-index:23;', EDAll), oSym['addTask'](0x5a, a);
				},
				'CoinRatio': 1.5,
				'SummonZombieArea': [
					undefined,
	...
	oS = {
		...
		'Lvl': 0x0,
		'DefaultStartGame'() {
			StopMusic(), PlayMusic(oS['StartGameMusic']), SetVisible($('tdShovel'), $('dFlagMeter'), $('dTop')), oS[
				'ControlFlagmeter'] && oFlagContent['init']({
		...
		'DefaultFlagToEnd'() {
			ShowWinItem(NewImg('imgSF', 'images/interface/Clearance_reward.png',
				'left:535px;top:200px;width:116px;height:119px;', EDAll, {
					'onclick': a => oS['Lvl']['indexOf']('jx') < 0x0 ? GetNewProp(a['target'],
						'Clearance_reward', $__language_Array__['39e48d7169def8d11f6bfab216eb7455'],
						$__language_Array__['d28efa2f99e9c27571354eccb0991caf'], NextLevel(), '30%', '43%'
					) : GetWin(a['target'], Exitlevel(oS['Lvl'], 0x1))
				}));
		},
		'GlobalVariables': {},
		'SelfVariables': [],
		...
		'Init': function(a, f, g, h) {
			...
			WIN['ArCard'] = [], WIN['ArPCard'] = {
					'SelNum': 0x0
				}, WIN['ArSun'] = {}, WIN['$Z'] = {}, WIN['$P'] = {}, WIN['EDAll'] = $('dAll'), WIN[
					'FightingScene'] = $('dFightingScene'), WIN['Ground'] = $('tGround'), WIN['EDPZ'] = $('dPZ'),
				WIN[
					'EDPZ_Spare1'] = $('dPZ_Spare1'), WIN['EDPZ_Spare2'] = $('dPZ_Spare2'), WIN['EDAlloffsetLeft'] =
				EDAll['offsetLeft'], WIN['EDAlloffsetTop'] = EDAll['offsetTop'], WIN['EDNewAll'] = EDAll[
					'cloneNode'](!![]), WIN['ESSunNum'] = $('sSunNum'),
				WIN['IsGaming'] = m => !!((m ? oGd === null || oGd === void 0x0 ? void 0x0 : oGd['$']['4_-2_1'] :
					oS['PName']['length'] > 0x0) && oSym['Timer']), j['PicArr'] = [], j['Coord'] = null, j['LF'] =
				null, j['ZF'] = null, j['isScroll'] = !![], j['backgroundImage'] = j['backgroundMask'] = null, j[
					'AudioArr'] = [], j['InitLawnMover'] = null, j['SummonZombieArea'] = null, j['ChoseCard'] = j[
					'MPID'] = '', j['PicNum'] = j['AccessNum'] = 0x0, j['MCID'] = null, j['Chose'] = 0x0, j[
					'SunNum'] = null, j['ArCard'] = null, j['HaveFog'] = null, j['AllowUserCard'] = null, j[
					'DynamicDifficulty'] = null, j['FixedProps'] = {}, j['ControlFlagmeter'] = 0x1, j[
					'isStartGame'] = 0x0, j['CoinRatio'] = undefined, j['CanSelectCard'] = undefined, j['DKind'] =
				undefined;
			for (let m in a) {
				j['SelfVariables']['push'](m), j[m] = a[m];
			};
			Object['assignWithoutOverwrite'](j, LevelConfig['query']()), j['LoadMusic'] && PlayMusic(j[
					'LoadMusic']), j['CanSelectCard'] === h && (j['CanSelectCard'] = 0x1), j['StaticCard'] === h &&
				(j[
					'StaticCard'] = 0x1), !j['CoinRatio'] && (j['CoinRatio'] = 0x0), j['DynamicDifficulty'] ===
				null && (j['DynamicDifficulty'] = ![]), !j['AllowUserCard'] && (j['AllowUserCard'] = ![]), !j[
					'SummonZombieArea'] && (j['SummonZombieArea'] = []), !j['PicArr'] && (j['PicArr'] = []);
			if (j['AllowUserCard']) {
				if (!j['PName'])
					j['PName'] = [];
				else {
					if (j['PName']['length'] > 0x0 && !localStorage['JNG_DEV'] && j['StaticCard'] === 0x1 && j[
							'CanSelectCard'] === 0x1) {
						var k;
						let n = [
								oPeashooter,
							...
							o = function() {
								...
								return q;
							}()['concat'](JSON['parse']((k = localStorage['JNG_TR_GotPlants']) !== null && k !==
								void 0x0 ? k : '[]'))['unique'](),
							p = {};
						for (let q of o) {
							p[q] = 0x1;
			...
			!j['ZName'] && (j['ZName'] = []), !j['LF'] && (j['LF'] = [
					...
					0x1,
					0x1
				]), !j['ZF'] && (j['ZF'] = j['LF']), !j['LoadAccess'] && (j['LoadAccess'] = null), !j['SunNum'] && (
					j['SunNum'] = 0x96), !j['ArCard'] && (j['ArCard'] = j['PName']), j['DKind'] === h && (j[
					'DKind'] = 0x1), j['ProduceSun'] === h && (j['ProduceSun'] = !![]), j['Coord'] == h && (j[
					'Coord'] = 0x1), oP['FlagToMonitor'] = g && g['FlagToMonitor'] || {}, oP['FlagToEnd'] = g && g[
					'FlagToEnd'] || j['DefaultFlagToEnd'], oCoord[j['Coord']](), oP['Init'](f), oT['Init'](j['R']),
				oZ['Init'](j['R']), oGd['Init'](), oBu['Init'](), oCoinContent['Init'](), j['LoadProgress']();
		},
		...
		'CheckImg': function() {
			const a = oS;
			(a['PicNum'] === 0x0 || ++a['AccessNum'] === a['PicNum']) && (SetNone($('loading')), a['LoadReady'](a),
				$('loadju')['onclick'] = null);
		},
		'LoadReady': function(a) {
			oSym['NowStep'] = $User['NowStep'], oSym['TimeStep'] = $User['TimeStep'], $('sFlagMeterTitleF')[
				'innerHTML'] = a['LevelName'], SetHidden($('dFlagMeterContent'), $('dFlagMeter'));
			let b = {
				'background': a['backgroundImage'] ? 'url(' + a['backgroundImage'] + ')\x20no-repeat' : '',
				'visibility': 'visible'
			};
			SetStyle($('tGround'), b), a['backgroundMask'] && FightingScene['classList']['add'](a[
				'backgroundMask']);
			const c = function(d) {
				NewImg('imgGrowSoil', 'images/interface/GrowSoil.gif', 'visibility:hidden;z-index:50',
					FightingScene), NewEle('dTitle', 'div', 0x0, 0x0, EDAll), innerText(ESSunNum, a[
					'SunNum']), InitPCard(), DisplayZombie(...a['SummonZombieArea']), oS['isScroll'] ? oSym[
					'addTask'](!d ? 0x5a : d, e => requestAnimationFrame(f => oS['ScrollScreen']())) : oS[
					'NoScroll']();
			};
		...
		'ScrollScreen'(a = 0x1, b = 0x0) {
			...
			if ((b += a) <= 0x1f4)
				...
				if (oS['CanSelectCard']) {
					const c = $('dSelectCard');
					SetVisible(c, $('dCardList')), SelectLockedCards(), oEffects['Animate'](c, {
						'top': '0px'
					}, 0.225, 'cubic-bezier(0.0,\x200.0,\x200.2,\x201)', d => {
						c['style']['pointer-events'] = 'auto', $User['_tmpARCARD'] && ($User['_tmpARCARD'][
							0x0
						] == oS['Lvl'] && ResetCards($User['_tmpARCARD'][0x1]), delete $User[
							'_tmpARCARD']);
		...
		'ScrollBack'(a, b = 0x1) {
			...
			(function d() {
				...
				EDAll['scrollLeft'] > 0xc0 + 0x73 ? b += 0.3 : b = Math['max'](b - 0.3, 0.3), (e -= b) > 0x73 ? (
					EDAll['scrollLeft'] = Math['floor'](e), c['style']['left'] = Math['floor'](e) + 'px',
					requestAnimationFrame(d)) : (EDAll['scrollLeft'] = 0x73, c['style']['left'] = '120px', oSym[
					'addTask'](0x0, a));
			}());
		}
	},
	...
	oP = {
		...
		'Init'(a) {
			...
			if (a) {
				...
				oP['FlagToEnd'] = e => {
					...
					g[oS['Lvl']] = 0x1, localStorage['JNG_TR_WON'] = JSON['stringify'](g), DataManager[
						'CheckAchievement']('lvl', g);
				};
				if (oS['DynamicDifficulty']) {
					...
					for (let g = 0x0; g < oP['FlagToSumNum']['a2']['length']; g++) {
						...
						oP['FlagToSumNum']['a2'][g] += f(g - 0x1 >= 0x0 ? oP['FlagToSumNum']['a1'][g - 0x1] : 0x0, g >=
							oP['FlagToSumNum']['a1']['length'] ? oP['FlagNum'] : oP['FlagToSumNum']['a1'][g]), oP[
							'FlagToSumNum']['a2'][g] = Math['round'](oP['FlagToSumNum']['a2'][g] * (0x1 +
							operateDynamicDifficulty() / 0xf)), oP['FlagToSumNum']['a2'][g] = Math['max'](oP[
							'FlagToSumNum']['a2'][g], 0x1), h == 0x0 && oP['FlagToSumNum']['a2'][g] > 0x0 && (oP[
							'FlagToSumNum']['a2'][g] = 0x0);
					}
				}
				if (oP['AZ']) {
					let j = oP['AZ']['sort']((n, o) => n[0x2] - o[0x2]),
						k = j['length'],
						l = [],
						m = {};
					oP['ArZ'] = [];
				...
				let c = oP['FlagNum'],
					d;
				c ? oP['MonPrgs'] = s => {
					(--oP['NumZombies'] <= 0x0 || oP['SpecialJudgment']['checks'][oP['FlagZombies']] && oP[
						'NumZombies'] <= oP['SpecialJudgment']['checks'][oP['FlagZombies']]) && (d = oP[
						'FlagZombies'], d < c ? (oP['ReadyFlag'] = ++d, oSym['addTask'](0x1f4, oP[
						'FlagPrgs'])) : toWin());
				} : oP['MonPrgs'] = s => {};
			}
		},
		'AddZombiesFlag'() {
			let a = oP,
				b = a['FlagNum'];
			PlayAudio('awooga'), oS['ControlFlagmeter'] && SetVisible($('dFlagMeterContent')), a['ReadyFlag'] = 0x1, a[
				'FlagPrgs']();
		},
		...
		'FlagPrgs'() {
			let a = oP['FlagZombies'],
				b = oP['FlagToSumNum'],
				c = $SSml(a, b['a1'], b['a2']),
				d;
			oP['FlagNum'] > (a = ++oP['FlagZombies']) && ((d = $SEql(a, oP['FlagToMonitor'])) && oSym['addTask'](oP[
				'SpecialJudgment']['maxTimes'][a] ? Math['max'](oP['SpecialJudgment']['maxTimes'][a] -
				0x12c, 0x1) : 0x69a, e => !d[0x1] && (d[0x0](), d[0x1] = 0x1)), oSym['addTask'](oP[
					'SpecialJudgment']['maxTimes'][a] ? Math['max'](oP['SpecialJudgment']['maxTimes'][a], 0x1) :
				0x7c6, e => oP['ReadyFlag'] === a && (oP['ReadyFlag'] = ++a, oP['FlagPrgs']()))), oS[
				'ControlFlagmeter'] && oFlagContent['update']({
				'curValue': a - 0x1
			}), oP['SelectFlagZombie'](c, a);
		},
		'Monitor'(a) {
			a && a['f'](...a['ar']);
			const b = oZ['traversalOf'],
				c = oBu['traversalOf']['bind'](oBu);
			(function d() {
	...
	oGd = {
		'Init'() {
			let a = this;
			a['$'] = {}, a['$Crater'] = [], a['$LockingGrid'] = {}, a['$Sculpture'] = {}, a['$Torch'] = {}, a[
					'$TrafficLights'] = {}, a['$Plantern'] = {}, a['$Obstacle'] = {}, a['$LF'] = oS['LF'], a['$ZF'] =
				oS['ZF'], a['$Ice'] = [], a['$GdType'] = [], a['$WaterDepth'] = [], a['$JackinTheBox'] = 0x0;
	...
	oZ = {
		...
		'getZ1': function(b, c, d = m => !![]) {
			...
			var e = 0x0,
				...
				g = this['$R'][c],
				h, j, k, l;
			(k = f['RefreshTime']) == g['RefreshTime'] ? h = g : (h = (this['$R'][c] = f['slice'](0x0))['sort'](
				function(m, n) {
		...
		'traversalOf'() {
			...
			for (let g = 0x1, h = a['length']; g < h; g++) {
				...
				while (k--) {
					let l = j[k];
					l['HP'] ? (l['PZ'] && l['ZX'] < 0x385 && oT['chkD' + l['WalkDirection']](l, g, oT['$'][g], oT['$L'][
						g
					]), b[l['ChkActs'](l, g, j, k)](l)) : (j['splice'](k, 0x1), b[0x0](l));
				}
				e = 0x3e8, c ? (c = d = 0x0, j['sort']((m, n) => m['AttackedLX'] - n['AttackedLX']), j['RefreshTime'] =
					oSym['Now']) : d && (d = 0x0, j['RefreshTime'] = oSym['Now']);
			}
		}
	},
	oT = {
		...
		'chkD1'(a, b, c, d) {
			let e = a['AttackedRX'],
				...
				g = c['RefreshTime'],
				h, j;
			g === d['RefreshTime'] ? h = d : (d = this['$L'][b] = c['slice'](0x0), h = d['sort']((k, l) => k[0x0] - l[
				0x0]), h['RefreshTime'] = g);
	...
	RewriteGlobalVariables = function(a, b) {
		for (let c in a) {
			b ? (!oS['GlobalVariables'][c] && (oS['GlobalVariables'][c] = WIN[c]), WIN[c] = a[c]) : !oS[
				'GlobalVariables'][c] && (oS['GlobalVariables'][c] = WIN[c], WIN[c] = a[c]);
		}
	},
	SelectModal = function(a, b) {
		ClearEventListeners(window, 'jng-event-startgame'), ClearEventListeners(window, 'jng-event-endgame'),
			StopMusic(), PausedAudioArr = [], oSelectionMap['_lastMusic_'] = oS['LoadMusic'] = oS['StartGameMusic'] =
			null;
		let c = oS['GlobalVariables'],
			d = oS['SelfVariables'];
		for (let e in c) {
			WIN[e] = c[e];
		}
		...
		oImage = {}, oS['SelfVariables']['length'] = 0x0, CancelShovel(), SetBlock($('loading')), SetHidden($(
				'dCardList'), $('tGround'), $('dSelectCard'), $('dTop'), $('dMenu'), $('dNewPlant')), SetNone($('Menu'),
				$('shade'), $('SelectionMap'), $('labMap')), dSurface['style']['display'] = a === 'Service/index.js' ||
			a === 'index' && b === 'Service' ? 'block' : 'none', EDAll = EBody['replaceChild'](EDNewAll, EDAll),
			LoadModal(a, b);
	},
	LoadModal = function(a, b = 'Level') {
		let c = 'modal/' + (/\w+?\/\w+?.js$/ ['test'](a) ? a : b + '/' + a + '.js');
		oS['Lvl'] = c['substring'](c['lastIndexOf']('/') + 0x1, c['indexOf']('.js')), /blob/ ['test'](a) && (c = a, oS[
			'Lvl'] = 'Fanmade', oS['OriginLvl'] = c), oSym['Timer'] && oSym['Stop'](), oSym['Init'](d => {
			ClearChild($('JSPVZ')), NewEle('JSPVZ', 'script', null, {
				'src': c
	...
	NewAudio = function(a) {
		...
		return d['preload'] = a['preload'] === undefined ? 'auto' : [
			...
			'meta',
			'none'
		][a['preload']], d['muted'] = oS['Silence'], a['loop'] ? d['loop'] = 'loop' : d['volume'] = 0.8, a[
			'callback'] && d['addEventListener']('canplaythrough', a['callback'], ![]), !a['loop'] && d[
			'addEventListener']('ended', f => {
			d['remove'](), d['src'] = '', delete oAudio[b];
		}, {
			'once': !![]
		}), e(), !!a['autoplay'] ? oAudio[b] = d : null;
	},
	...
	loadRes = function(a, b) {
		let c = NewAudio,
			e = document['getElementsByTagName']('head')[0x0];
		if (a['js']) {
			let f = a['js'][0x0],
				g = 0x0;
		...
		if (a['img']) {
			...
			}), m['length'] > 0x0 && (m['splice'](0x0, 0x0, j), loadRes({
				'video': m
			}));
		}
		if (a['video']) {
	...
	InheritO = function(a, b) {
		let c = function() {};
		return c['prototype'] = new a(), b && Object['assign'](c['prototype'], b), Object['defineProperty'](c[
