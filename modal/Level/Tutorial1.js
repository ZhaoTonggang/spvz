...
oS.Init({
	...
	PicArr: function() {
		let a = oSunFlower.prototype,
			b = a.PicArr;
		return [RESPATH + "SodRoll.png", RESPATH + "background1unsodded_1.webp", RESPATH +
			"background1unsodded.webp", b[a.CardGif], b[a.StaticGif]
		];
	}(),
	...
	StartGame: function() {
		...
		NewEle("sod3row", "div",
			"position:absolute;left:-115px;top:0;height:600px;width:264px;z-index:0;background:url(images/interface/background1unsodded_1.webp);over-flow:hidden",
			0, EDPZ);
		...
		(function fun(e, h, b, d, c, g, a, f) {
			...
			e < 990 ? oSym.addTask(3, fun, [e, h, b, d, c, g, a, f]) : (ClearChild($("SodRoll_1")),
				function() {
					oS.InitLawnMover();
					oP.Monitor({
						ar: [0],
						f: function fun(k) {
							...
							switch (k) {
								case 0:
									...
									;
									PlaySubtitle($__language_Array__[
										"5a3482fc2e771776704e108ec256f346"]);
									!$("PointerUD2") && NewImg("PointerUD2",
										"images/interface/down.gif",
										"top:60px;left:35px;-moz-transform:scaleY(-1);-webkit-transform:scaleY(-1);-o-transform:scaleY(-1);transform:scaleY(-1);filter:FlipV;",
										FightingScene);
									oSym.addTask(10, fun, [++k]);
									break;

								case 1:
									i > 0 && (PlaySubtitle($__language_Array__[
											"3dfa94dd23c35e89a6db3d0679ac6308"]),
										EditImg($("PointerUD2"), "",
											"images/interface/down.gif", {
												left: "165px",
												top: "250px",
								...
								case 2:
									...
									while (--l) {
										if (h["3_" + l + "_1"]) {
											...
											AppearSun(Math.floor(GetX(7) + Math
												.random() * 41), GetY(3), 50, 0);
											oSym.addTask(10, fun, [++k]);
											return;
										}
									}
								...
								case 3:
									oS.SunNum > 99 && (AutoProduceSun(50), ClearChild($(
										"PointerUD2")), PlaySubtitle(
										$__language_Array__[
											"9633a9250ddc826bc76b6f16ec78151c"]
									), ++k);
									oSym.addTask(10, fun, [k]);
									break;
								...
								default:
									...
									j > 0 ? (oP.AddZombiesFlag(), oFlagContent.show(),
											oSym.addTask(800, PlaySubtitle)) : oSym
										.addTask(10, fun, [4]);
							}
						}
					});
	...
	FlagToEnd: function() {
		let dom = NewEle("", "div",
			"position:absolute;left:300px;top:300px;overflow:visible;width:100px;height:60px;", {},
			EDAll);
